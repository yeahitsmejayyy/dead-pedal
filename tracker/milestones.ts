  ...
  },
  {
    ...
    tasks: [
      ...
      },
      {
        ...
        note: 'Vehicles done. Slice 1: burning-dusk sky dome, seeded silhouette city with smoke, tiled high-desert dirt (ambientCG Ground067, CC0), dusk lighting and fog. Slice 2: chain-link perimeter on a concrete kerb with steel posts, prison-style razor-wire coils on inward-leaning arms — real helical tubes, roughly 50k triangles for the whole perimeter and still one draw call, because a concertina coil is something you see THROUGH and no cut-out quad can fake that, rust, kinked two-segment posts, per-span kerb, and spans torn down to stubs or left sagging off a post, and dirt ramps UV-projected per face off the world axes. Wear is geometry rather than texture — a tear baked into a tile would repeat every 2.4m around a 720m perimeter and read as a pattern. 62 draw calls against a budget of 100. Left: props along the wall, and the concrete blocks still read as placeholders.',
      },
      {
        id: 'm7-music',
