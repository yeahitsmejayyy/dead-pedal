...
export const MILESTONES: readonly Milestone[] = [
  ...
  },
  {
    ...
    tasks: [
      ...
      { id: 'm7-engine', label: 'Engine audio driven by RPM and load', done: true, note: 'Synthesised: CC0 loops span 0.84 octaves, the gearbox needs 3.17.' },
      {
        id: 'm7-sfx',
        label: 'Weapon, impact and UI sounds',
        done: false,
        note: 'CC0 samples wired but too cartoony. Regenerating in ElevenLabs.',
      },
      { id: 'm7-sfx-wire', label: 'Wire the unwired events: lockOn, mineBeep, landed, damaged, matchEnded, respawn, 3-2-1', done: false },
